...
CREATE TABLE CATEGORYGROUPTABLE(categoryGroupTableID INTEGER PRIMARY KEY AUTOINCREMENT, categoryGroupName VARCHAR(63));
CREATE TABLE PICTURETABLE(pictureTableID INTEGER PRIMARY KEY AUTOINCREMENT, pictureFileName VARCHAR(63), transactionID INTEGER );
CREATE TABLE LABELSTABLE(labelsTableID INTEGER PRIMARY KEY AUTOINCREMENT, labelName VARCHAR(63), transactionIDLabels INTEGER );
CREATE TABLE SETTINGSTABLE(settingsTableID INTEGER PRIMARY KEY AUTOINCREMENT, defaultSettings VARCHAR(40) );
CREATE TABLE SMSSTABLE(smsTableID INTEGER PRIMARY KEY AUTOINCREMENT, senderName VARCHAR(63), senderDefaultName VARCHAR(63), senderCategoryID INTEGER, senderAccountID INTEGER, senderAmountOrder INTEGER );
CREATE TABLE FILTERSTABLE(filtersTableID INTEGER PRIMARY KEY AUTOINCREMENT, filtername VARCHAR(255), filterJSON VARCHAR(255) );
CREATE TABLE NOTIFICATIONTABLE(smsTableID INTEGER PRIMARY KEY AUTOINCREMENT, notificationPackageName VARCHAR(255), notificationAppName VARCHAR(255), notificationDefaultName VARCHAR(255), notificationSenderCategoryID INTEGER, notificationSenderAccountID INTEGER, notificationSenderAmountOrder INTEGER );
